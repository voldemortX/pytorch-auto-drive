...
python main_landec.py --state=2 --batch-size=80 --continue-from=resnet34_baseline_tusimple.pt --dataset=tusimple --method=baseline --backbone=resnet34 --mixed-precision --exp-name=resnet34_baseline_tusimple
