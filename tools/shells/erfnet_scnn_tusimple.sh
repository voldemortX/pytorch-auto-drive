...
python main_landec.py --state=2 --batch-size=80 --continue-from=erfnet_scnn_tusimple.pt --dataset=tusimple --method=scnn --backbone=erfnet --mixed-precision --exp-name=erfnet_scnn_tusimple
