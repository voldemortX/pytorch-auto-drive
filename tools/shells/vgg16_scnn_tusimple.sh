...
python main_landec.py --state=2 --batch-size=80 --continue-from=vgg16_scnn_tusimple.pt --dataset=tusimple --method=scnn --backbone=vgg16 --mixed-precision --exp-name=vgg16_scnn_tusimple
