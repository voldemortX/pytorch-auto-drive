...
python main_landec.py --state=2 --batch-size=32 --continue-from=resnet101_baseline_tusimple.pt --dataset=tusimple --method=baseline --backbone=resnet101 --workers=4 --mixed-precision --exp-name=resnet101_baseline_tusimple
