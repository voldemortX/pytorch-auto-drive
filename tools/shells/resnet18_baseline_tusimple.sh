...
python main_landec.py --state=2 --batch-size=80 --continue-from=resnet18_baseline_tusimple.pt --dataset=tusimple --method=baseline --backbone=resnet18 --mixed-precision
