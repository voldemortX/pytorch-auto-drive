...
python main_landec.py --state=2 --batch-size=32 --continue-from=resnet101_scnn_tusimple.pt --dataset=tusimple --method=scnn --backbone=resnet101 --workers=4 --mixed-precision
