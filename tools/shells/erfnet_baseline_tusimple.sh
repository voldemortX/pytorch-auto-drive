...
python main_landec.py --state=2 --batch-size=80 --continue-from=erfnet_baseline_tusimple.pt --dataset=tusimple --method=baseline --backbone=erfnet --mixed-precision --exp-name=erfnet_baseline_tusimple
