...
class RESANet(nn.Module):
    def __init__(self, num_classes, backbone_name, flattened_size, pretrained_backbone=True):
        ...
        self.channel_reducer = RESAReducer(in_channels=in_channels, reduce=128)
